...
public class PersonRestControllerItTest {
    ...
    public void getAllPersons(){
        ...
        expected.add("{id:2,name:Venic,surname:Cooper}");
        expected.add("{id:1,name:Dexter,surname:Armagedon}");
    ...
    public void testGetOnePersons(){
        ...
        String expected = "{id:2,name:Venic,surname:Cooper}";
